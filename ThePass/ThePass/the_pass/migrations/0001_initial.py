...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('winter', models.CharField(choices=[('3Б', '3Б'), ('1Б', '1Б'), ('3А', '3А'), ('2А', '2А'), ('2Б', '2Б'), ('1А', '1А')], default='1А', max_length=2, verbose_name='Зима')),
                ('spring', models.CharField(choices=[('3Б', '3Б'), ('1Б', '1Б'), ('3А', '3А'), ('2А', '2А'), ('2Б', '2Б'), ('1А', '1А')], default='1А', max_length=2, verbose_name='Весна')),
                ('summer', models.CharField(choices=[('3Б', '3Б'), ('1Б', '1Б'), ('3А', '3А'), ('2А', '2А'), ('2Б', '2Б'), ('1А', '1А')], default='1А', max_length=2, verbose_name='Лето')),
                ('autumn', models.CharField(choices=[('3Б', '3Б'), ('1Б', '1Б'), ('3А', '3А'), ('2А', '2А'), ('2Б', '2Б'), ('1А', '1А')], default='1А', max_length=2, verbose_name='Осень')),
            ],
        ),
        migrations.CreateModel(
            name='MyUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('AC', 'принят'), ('NW', 'новый'), ('RJ', 'отклонён'), ('PN', 'в работе')], default='NW', max_length=2)),
