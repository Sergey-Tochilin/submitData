...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('winter', models.CharField(choices=[('2Б', '2Б'), ('1А', '1А'), ('3Б', '3Б'), ('1Б', '1Б'), ('2А', '2А'), ('3А', '3А')], default='1А', max_length=2, verbose_name='Зима')),
                ('spring', models.CharField(choices=[('2Б', '2Б'), ('1А', '1А'), ('3Б', '3Б'), ('1Б', '1Б'), ('2А', '2А'), ('3А', '3А')], default='1А', max_length=2, verbose_name='Весна')),
                ('summer', models.CharField(choices=[('2Б', '2Б'), ('1А', '1А'), ('3Б', '3Б'), ('1Б', '1Б'), ('2А', '2А'), ('3А', '3А')], default='1А', max_length=2, verbose_name='Лето')),
                ('autumn', models.CharField(choices=[('2Б', '2Б'), ('1А', '1А'), ('3Б', '3Б'), ('1Б', '1Б'), ('2А', '2А'), ('3А', '3А')], default='1А', max_length=2, verbose_name='Осень')),
            ],
        ),
        migrations.CreateModel(
            name='MyUser',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('accepted', 'принят'), ('new', 'новый'), ('pending', 'в работе'), ('rejected', 'отклонён')], default='new', max_length=8)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pereval', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='the_pass.pereval', verbose_name='Изображения')),
            ],
        ),
    ]
